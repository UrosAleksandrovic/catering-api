...
internal class GetIdentityWithMenuIdHandler : IRequestHandler<GetIdentityWithMenuId, Identity>
{
    ...
    public async Task<Identity> Handle(GetIdentityWithMenuId request, CancellationToken cancellationToken)
    {
